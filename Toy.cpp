...
Toy::Toy(Ogre::SceneNode* _node, Ogre::SceneManager* _msm): gameObject(_node)
{
	...
	Ogre::Entity* entCuerpo =_msm->createEntity("cuerpoToy", "uv_sphere.mesh");//Cuerpo como hijo del cuello
	entCuerpo->setMaterialName("ShadersCorrosion");
	...
	Ogre::Entity* entCabeza = _msm->createEntity("cabezaToy", "uv_sphere.mesh");
	entCabeza->setMaterialName("ShadersCorrosion");
