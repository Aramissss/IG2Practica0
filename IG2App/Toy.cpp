...
Toy::Toy(Ogre::SceneNode* _parentNode): gameObject(_parentNode)
{
	

	nodeCuello= _parentNode->createChildSceneNode("nCuello");//Cuello como hijo del plano
	nodeCuello->setScale(1, 1, 1);
	nodeCuello->setPosition(0, 0, 0);

	mainNode = nodeCuello;

	Ogre::Entity* entCuerpo = _parentNode->getCreator()->createEntity("sphere.mesh");//Cuerpo como hijo del cuello
	...
	Ogre::Entity* entOmb = _parentNode->getCreator()->createEntity("sphere.mesh");
	...
	Ogre::Entity* entCabeza = _parentNode->getCreator()->createEntity("sphere.mesh");
	...
	Ogre::Entity* entNariz = _parentNode->getCreator()->createEntity("sphere.mesh");
	...
	Ogre::Entity* entBoca = _parentNode->getCreator()->createEntity("sphere.mesh");
	...
	Ogre::Entity* entOjoI = _parentNode->getCreator()->createEntity("sphere.mesh");
	...
	Ogre::Entity* entOjoD = _parentNode->getCreator()->createEntity("sphere.mesh");
